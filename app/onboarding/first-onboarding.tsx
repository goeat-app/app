...
import { View, Image, Pressable, FlatList, useWindowDimensions } from "react-native";
...
export default function OnBoardingCarousel() {
    ...
    const onboardingSteps = [
        { 
            ...
            description: 'Com o GoEat você consegue descobrir restaurantes que são exatamente o que você quer',
        },
        {
            id: '2',
            image: require('@/assets/images/goat-phone.png'),
            title: 'Como a mágica acontece?',
            description: 'Usamos seu perfil, os lugares que você curte e o que pessoas como você gostam para achar seu próximo restaurante favorito',
        }
    ];

    function OnBoardingItem({ item, width}){
    return (
        <View className="items-center justify-center gap-4 px-4" style={{ width: width, height: '100%' }}>
            ...
            <View className="flex-2 justify-start items-center">
                <View className="w-full items-center gap-2">
                    <Typography
                        type='h2'
                        className='text-[#FF6B35] font-poppins-bold text-center'
                        text={item.title}
                        numberOfLines={2}
            ...
            <View className="flex-1 w-full gap-6 px-4 justify-center">
                ...
                >
                    <Typography
                        ...
                        text={activeIndex === onboardingSteps.length - 1 ? 'Começar' : 'Próximo'}
                    />
                </Button>
